...
describe('BookService', () => {
  ...
  test('should create a new book', async () => {
    ...
    expect((book as any).author).toBeDefined();
  });
  ...
  test('should get all books', async () => {
    ...
    expect((books[0] as any).author).toBeDefined();
  });
  ...
  test('should get book by id', async () => {
    ...
    expect((foundBook as any)?.author).toBeDefined();
  });
  ...
  test('should update a book', async () => {
    ...
    expect((updatedBook as any).author).toBeDefined();
  });
  ...
  test('should get books by author id', async () => {
    ...
    await bookService.createBook({ title: 'Book by Test Author 1', summary: 'Summary 1', publicationYear: 2020, authorId: testAuthor.id });
    await bookService.createBook({ title: 'Book by Test Author 2', summary: 'Summary 2', publicationYear: 2021, authorId: testAuthor.id });
    await bookService.createBook({ title: 'Book by Another Author', summary: 'Summary 3', publicationYear: 2022, authorId: anotherAuthor.id });
    ...
    expect((booksByTestAuthor[0] as any).author).toBeDefined();
  });
